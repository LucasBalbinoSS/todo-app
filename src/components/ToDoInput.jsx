  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <button disabled={!todoValue} className="flex-grow h-[2.875rem] disabled:opacity-50 disabled:hover transition-opacity bg-[#845AFC] enabled:hover:bg-[#6934fa] transition-colors duration-300 text-white px-3 rounded-md" onClick={() => {
          if (todoValue.trim() != '') {
